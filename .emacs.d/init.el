...
;; CONFIG
;; -------------------------------------------------------------
(defvar satori/font-size 230)  ;; Sets the font size of the editor
;; --- UI
(defvar satori/tool-bar 0)            ;; Hide the icon toolbar
(defvar satori/bar-mode 0)            ;; Hide the top menu bar
(defvar satori/scroll-bar 0)          ;; Hide scrollbars
(defvar satori/fringe-mode 0)         ;; Remove fringes (thin margins on left/right of buffer)
;; --- ORG AGENDA
(defvar satori/agenda-files
  "~/projects/satori-notes/agenda/")
(defvar satori/agenda/span-days 14)
(defvar satori/theme 'ef-dream)
...
(defun satori/set-various-ui-elements()
  (print "Disabling various ui elements")
  (tool-bar-mode satori/tool-bar)    
  (menu-bar-mode satori/bar-mode)    
  (scroll-bar-mode satori/scroll-bar) 
  (set-fringe-mode satori/fringe-mode) 
)
...
(use-package org
  ...
  :custom
  (org-agenda-span satori/agenda/span-days)
  (satori/org/styling/headings)
  :config
  (setq org-agenda-files
        (directory-files satori/agenda-files t "\\.org$"))
...
;; -------------------------------------------------------------
(defun satori/org/styling/headings()
...
;; -------------------------------------------------------------
;; SECTION TYPESCRIPT TS MODE
;; -------------------------------------------------------------

(defun satori/setup-typescript()
  (add-hook 'typescript-ts-mode-hook #'lsp-deferred)
  (add-hook 'typescript-ts-mode-hook #'display-line-numbers-mode)
  (add-hook 'typescript-ts-mode-hook #'corfu-mode)
...
(defun satori/experimental()
  (print "EXPERIMENTAL SECITON")
  )
...
(use-package emacs
  :init
  (print "hello emacs")
  (satori/set-font-size satori/font-size)
  (satori/set-various-ui-elements)
